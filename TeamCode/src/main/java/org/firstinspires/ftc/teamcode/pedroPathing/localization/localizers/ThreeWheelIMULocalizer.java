...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0029561460323358517;
    public static double STRAFE_TICKS_TO_INCHES = -0.0030611992603021814;
    public static double TURN_TICKS_TO_RADIANS = 0.003042425003170012;
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        hardwareMap = map;
        imu = hardwareMap.get(IMU.class, PartsMap.IMU.toString());

        imu.initialize(new IMU.Parameters(new RevHubOrientationOnRobot(RevHubOrientationOnRobot.LogoFacingDirection.UP, RevHubOrientationOnRobot.UsbFacingDirection.LEFT)));

        leftEncoderPose = new Pose(2, 7.9, 0);
        rightEncoderPose = new Pose(2, -7.9, 0);
        strafeEncoderPose = new Pose(6, 1, Math.toRadians(90));

        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, PartsMap.DRIVE_BL.toString()));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, PartsMap.DRIVE_BR.toString()));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, PartsMap.DRIVE_FL.toString()));
