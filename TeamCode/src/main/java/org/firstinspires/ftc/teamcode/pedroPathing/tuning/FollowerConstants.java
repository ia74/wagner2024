...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = PartsMap.DRIVE_FL.toString();
    public static String leftRearMotorName = PartsMap.DRIVE_BL.toString();
    public static String rightFrontMotorName = PartsMap.DRIVE_FR.toString();
    public static String rightRearMotorName = PartsMap.DRIVE_BR.toString();

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 51.4966;
    private static double yMovement = 42.142;
    ...
    public static double centripetalScaling = 0.000645;
    ...
    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -82.94;
