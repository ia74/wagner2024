...
public class LConstants {
    static {
        ...
        ThreeWheelConstants.leftEncoder_HardwareMapName = PartsMap.DRIVE_FL.toString();
        ThreeWheelConstants.rightEncoder_HardwareMapName = PartsMap.DRIVE_BR.toString();
        ThreeWheelConstants.strafeEncoder_HardwareMapName = PartsMap.DRIVE_FR.toString();
